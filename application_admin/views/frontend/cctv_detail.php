...
<body>
    ...
    <div class="ts-page-wrapper ts-has-bokeh-bg" id="page-top">
        ...
        <section class="loader w-100 d-flex flex-column align-items-center justify-content-center h-100 bg-white position-fixed top-0" style="z-index:100">

            <img style="width: 100%; height: 300px; object-fit: contain; " src="<?= base_url('/assets_admin/img/cctv.gif') ?>" alt="">
            <span class="loading-text"> Loading CCTV data... </span>
        </section>
