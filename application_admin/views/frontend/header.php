...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-WSF4G2H260"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-WSF4G2H260');
</script>
<style> 
  ...
  * {
    ...
    overflow-x: hidden;
    font-family: "Mitr", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen,
  ...
  <?php 
    ...
    if(strpos($actual_link,"en-EN") || strpos($actual_link,'th-TH')){
      $actual_link = $LANG == "en-EN" ? str_replace('en-EN','th-TH',$actual_link) : str_replace('th-TH','en-EN',$actual_link);
    }else{
      $actual_link = $actual_link."th-TH";
    }
    
    
  ?>

<div class="navbar-over d-flex align-items-end justify-content-end py-2 px-3 gap-3" >
  ...
  <div>
  Open Hours Mon-Fri : 09:00 - 17:00 WIB
  </div>
...
<nav class="navbar navbar-expand-lg px-sm-0 px-lg-3 overflow-visible">
  ...
  <div class="container-fluid overflow-visible header-container">
    ...
    <!-- <form action="<?= base_url($LANG."/search") ?>" class="d-flex mx-2 gap-2 ">
            <input class="search-input" type="text" placeholder="Search" name="q" id="searchData" required>
            <button class="border-0" style="background: transparent; color:white"><i class="fa-solid fa-magnifying-glass"></i></button>

            </form> -->
          <a class="d-flex gap-1 align-items-center justify-content-center nav-link btn-lang" href="<?= $actual_link ?>"> 
            <i class="fa-solid fa-globe"></i>
            <div class="px-2"> <?= $LANG == "en-EN" ? "EN" : "TH" ?> </div>
    ...
    <div class="collapse navbar-collapse justify-content-center overflow-visible" id="navbarNav">
      ...
      <ul class="navbar-nav overflow-visible">
        ...
        <li class="list-search search-header-group">
        <form action="<?= base_url($LANG."/search") ?>" style="width: 90%;" class="d-flex mx-2 gap-2 " >
            <input class="search-input" type="text" placeholder="Search" name="q" id="searchData" style="width: 100%;" required value="<?= isset($_GET['q']) ? $_GET['q'] : "" ?>">
            <button class="border-0" style="background: transparent; color:white"><i class="fa-solid fa-magnifying-glass"></i></button>

            </form>

          <a class="d-flex gap-1 align-items-center justify-content-center nav-link btn-lang" style="min-width: 100px;" href="<?= $actual_link ?>"> 
            <i class="fa-solid fa-globe"></i>
            <div class="px-2"> <?= $LANG == "en-EN" ? "EN" : "TH" ?> </div>
          </a>
        </li>
