...
<?php 
    ...
    if($LANG == 'en-EN' ){
      ...
      $search = "What's in you mind ? Find here ";
  ...
  <main>
    <section class="section-banner">
      <div class="banner-cover">
        <h1 class="banner-header">Buddy Motor</h1>
        <p class="banner-detail">
          Buddymotors - Auto Parts, Lighting, and Accessories<br>
          Established in 1993, Buddymotors is a trusted partner of Motorzoom Indonesia.
        </p>
      </div>
      <div class="banner-media">
        ...
        <video width="1124" height="710" playsinline="" webkit-playsinline="" autoplay loop="true" src="<?= base_url('/assets/video/UrusS_360deg-Esterni_v1.1.0.mp4') ?>" preload="metadata" style="width: 100%; height: 100%; object-fit: cover;" muted="muted"></video>
      </div>
    </section>
    ...
    <section class="section-search">
      <div class="d-flex row align-items-start justify-content-center">
        <div class="col-md-6 d-flex flex-column p-5 align-items-center align-items-sm-center align-items-lg-start ">
          <h1><?= $search ?></h1>
          <span>Making it easy to find your dream. Enter your keyword and browse the best parts car. </span>
    ...
    <section class="section-space mt-3">
      ...
      <div class="space-item">
        ...
        <div class="space-text">Buddymotors - Auto Parts, Lighting, and Accessories. </div>
      </div>
      <div class="line"></div>
    ...
    <div class="container-section">
      <section class="section-social  position-relative ">
        ...
        <div class="product social-image-container overflow-hidden ">
          ...
          <div class="product-image social-image rounded">
          <a href="https://instagram.com/shop.buddymotor?igshid=cXRkZGFlbmZnbGU3" target="_blank"><img src="https://www.dumbchat.ai/wp-content/uploads/2022/06/220120-47456-1.jpg" alt="" /></a>
          </div>
        </div>
        ...
        <div class="product social-image-container overflow-hidden ">
          ...
          <div class="product-image social-image rounded">
            <a href="https://line.me/ti/p/~@buddymotor" target="_blank"><img src="https://play-lh.googleusercontent.com/74iMObG1vsR3Kfm82RjERFhf99QFMNIY211oMvN636_gULghbRBMjpVFTjOK36oxCbs=w240-h480-rw" alt="" /></a>
          </div>
        </div>
        ...
        <div class="product social-image-container overflow-hidden ">
          ...
          <div class="product-image social-image rounded">
          <a href="https://www.tiktok.com/" target="_blank"><img src="https://play-lh.googleusercontent.com/Ui_-OW6UJI147ySDX9guWWDiCPSq1vtxoC-xG17BU2FpU0Fi6qkWwuLdpddmT9fqrA" alt="" /></a>
          </div>
        </div>
...
<script>
  ...
  let slidePos = [60, 55, 20, -14];
  let slidePosBack = [20, -14];
  ...
  $("#btn-prev").click((e) => {
    ...
    let carName = $(`.slide-car-item[data-index="${0}"] span`)[0].innerText

    if (document.body.clientWidth <= 992) {
      carName = $(`.slide-car-item[data-index="${slideItems-1}"] span`)[0].innerText
    }
  ...
  $("#btn-next").click((e) => {
    ...
    let carName = $(`.slide-car-item[data-index="${1}"] span`)[0].innerText

    if (document.body.clientWidth <= 992) {
      carName = $(`.slide-car-item[data-index="${0}"] span`)[0].innerText
    }
    let fullCarName = ''
    let i = 0
