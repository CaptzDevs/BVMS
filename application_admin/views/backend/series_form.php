    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="<?= base_url("/Admin/Series/").$model_id ?>">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Series <?= $seriesData['series_name'] ?></li>
            </ol>
        </div>
        <!--Page Header-->
        ...
        <section class="banner">
            ...
            <div class="d-flex align-items-md-center align-items-center justify-content-center flex-column flex">
                <h2>Edit Series  <?= $seriesData['series_name'] ?></h2>
        ...
        <div class="row row-sm form-appointment">
            <div class="col-md-12">
                <div class="card mg-b-20">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-12 col-md-12 px-0">
                                    <div class="form-group mg-b-0">
                                        <label class="form-label"> Series Name <span class="tx-danger"></span></label>
                                        <input class="form-control" id="series_name" name="series_name" placeholder="  Series Name" required="" type="text" value="<?= $seriesData['series_name'] ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-sm-12">
                                    <div class="dropzone mb-2" id="dz-image">
                                        <div class="dz-message" data-dz-message><span>Add Series Logo <i class="fas fa-image"></i> <?= $edit ? "" : "" ?> </span></div>
                                    </div>
                    ...
                    <?php if(strlen($seriesData['series_image']) > 0){ ?>
                    <h3 class="px-4">Logo</h3>
                        <div class="row align-items-start justify-content-start px-3">
                                <div class="col-xl-4" id="card-image-<?= $seriesData['id'] ?>">
                                    <div class="card mg-b-20">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body px-3 px-lg-0" style="margin-left: 10px;">
                                                        ...
                                                        <nav class="d-flex justify-content-between nav">
                                                            <div class="nav-link btn-delete-image" data-id="<?= $seriesData['id'] ?>"><i class="fas fa-ban"></i> Delete</div>
                                                ...
                                                <div class="media-list">
                                                    <div class="media">
                                                        <div class="media-body ">
                                                            ...
                                                            <img style="width: 50%;" src="<?= base_url("/uploads/image/") . $seriesData['series_image'] ?>" alt="">
