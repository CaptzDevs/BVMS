    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Brand <?= $modelData['model_name'] ?></li>
            </ol>
        </div>
        <!--Page Header-->
        ...
        <section class="banner">
            ...
            <div class="d-flex align-items-md-center align-items-center justify-content-center flex-column flex">
                <h2>Edit Brand  <?= $modelData['model_name'] ?></h2>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-12 col-md-12 px-0">
                                    <div class="form-group mg-b-0">
                                        ...
                                        <input class="form-control" id="model_name" name="model_name" placeholder="  Brand Name" required="" type="text" value="<?= $modelData['model_name'] ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-sm-12">
                                    <div class="dropzone mb-2" id="dz-image">
                                        <div class="dz-message" data-dz-message><span>Add Model Logo <i class="fas fa-image"></i> <?= $edit ? "" : "" ?> </span></div>
                                    </div>
