                            ...
                            <form class="mt-3 form-appointment " id="form_login" onsubmit="return false">
                                ...
                                <div class="row row-sm">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="user_email" placeholder="อีเมล" required="" type="email" data-parsley-error-message="รูปแบบอีเมลไม่ถูกต้อง">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-8 d-flex justify-content-center m-0">
                                        <button class="btn btn-main-primary btn-submit" id="btn_login" type="submit">เข้าสู่ระบบ</button>
                                    </div>

                                    <div class="col-4 d-flex justify-content-center">
                                        <a href="<?= base_url("/Client/register") ?>" class="btn btn-main-primary btn-register w-100 d-flex align-items-center justify-content-center">
                                            ลงทะเบียน
                                        </a>
                                    </div>
                                </div>
...
<!-- 
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <button class="btn-fb d-flex align-items-center justify-content-center" onclick="facebookLogin(this)">
                            ...
                            <div id="g_id_onload" data-client_id="678390382211-lor76k8fhlrltrbjqqkjdlhnpdg86h3i.apps.googleusercontent.com" data-context="signin" data-ux_mode="popup" data-callback="getGoogleUser" data-nonce="" data-itp_support="true">
                            </div>


                            <div class="row mt-3">
                                <div class="col-12 d-flex align-items-center justify-content-center" id="btn_warp_gg">
                                    <!--  <button class="btn-gg d-flex align-items-center justify-content-center" onclick="">
                                    ...
                                    data-theme="outline" data-text="continue_with" data-size="large" data-logo_alignment="left" data-width="250">
                                    </div>
                                </div>
                            </div>
