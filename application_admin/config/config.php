...
|
*/
/* $config['base_url'] = 'https://www.bvms.com.122.155.18.112.no-domain.name/'; */
$config['base_url'] = 'http://localhost/bvms';
...
$config['sess_cookie_name'] = 'bvms_sess';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = 'D:\WWW\Program Training Center\BVMS\cache\session';
