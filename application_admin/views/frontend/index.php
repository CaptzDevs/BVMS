...
<body>
  <header>
    <div class="d-flex">
      ...
      <a class="nav-link" href="<?=  base_url('/admin.php/DashboardView/Map') ?>"> Map </a>
          ...
          <div class="overview-status">
            <div class="overview-status-item">
              ...
              <div class="overview-status-item-detail">
                ...
                <div> <span class="http"> <?= $cctvData['available_http'] ?> </span> / <span class="http_total"> <?= $cctvData['total_http'] ?> </span> unit</div>
              </div>
            </div>
            <div class="overview-status-item">
              <label>Https</label>
              <div class="overview-status-item-detail">
                <div class="status-online-circle"></div>
                <div> <span class="https"> <?= $cctvData['available_https'] ?> </span> / <span class="https_total"> <?= $cctvData['total_https'] ?> </span> unit</div>
            ...
            <div class="overview-status-item">
              ...
              <div class="overview-status-item-detail">
                <div class="status-online-circle"></div>
                <div> <span class="available_total"> <?= $cctvData['avaliavle_total'] ?> </span> / <span class="cctv_total"> <?= $cctvData['total_cctv'] ?> </span> unit</div>

              </div>
            </div>
          </div>
          <a href="<?= base_url('/admin.php/DashboardView/map')  ?>" class="btn-map"> View Map </a>
        </div>
      </section>
...
<!--       <section class="my-5 row">
      ...
      <a href="<?= base_url('/admin.php/DashboardView/Map') ?>">
