...
<div class="main-content px-0 hor-content" style="margin-top: 100px !important;">
	...
	<div class="container">
		...
		<div class="page-header">
			<h3 class="page-title">Slide List</h3>
				...
				<div class="card mg-b-20">
					<div class="card-body row pt-0">
						<div class="col-lg-12 col-md-12 mt-3">
							<a href="<?= base_url("/Admin/Slide") ?>" class="form-group mg-b-0">
								<button class="btn-create">Add New Slide</button>
							</a>
						</div>
						...
						<tbody>
							<?php foreach ($articleList as $key => $value) { ?>
								<tr data-id="<?= $value['id'] ?>">
									...
									<td>
										<a href="<?= isset($_SESSION['id']) ?  base_url('/Admin/Slide/') . $value['id'] : base_url('/Client/Slide/') . $value['id'] ?>">
											<h2><?= $value['slide_name'] ?></h2>
											<h5><?= $value['slide_name_eng'] ?></h5>
										</a>
									...
									<td class="text-center ">
										<a href="<?= base_url("/Admin/Slide/").$value['id'] ?>">
