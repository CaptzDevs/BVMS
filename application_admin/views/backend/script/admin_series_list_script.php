 ...
 */
    ...
    function sendSearchRequest(value) {
        ...
        var url = `<?= base_url('/Control/searchSeries') ?>`;
        console.log(value);
        var postData = {
            searchSeries: value,
            model_id: <?= $model_id ?>,
    ...
    function sendEditRequest(id) {
        var url = `<?= base_url('/Control/editSeries') ?>`;

        var postData = {
            id: id,
            model_id: <?= $model_id ?>,
            series_name: $(`#category-name-${id}`).val(),
        };
    ...
    function sendDeleteRequest(id) {
        var url = `<?= base_url('/Control/deletSeriesPermanant') ?>`;
    ...
    function sendPostRequest() {
        var url = `<?= base_url('/Control/saveSeries') ?>`;

        var postData = {
            series_name: $("#new_category_name").val(),
            model_id: <?= $model_id ?>,
