...
<div class="main-content px-0 hor-content" style="margin-top: 100px !important;">
	...
	<div class="container">
		...
		<div class="page-header">
			<h3 class="page-title">Series List</h3>
							...
							<div class="card-body row pt-0">
									<div class="col-lg-1/ col-md-12 mt-3">
										...
										<div class="form-group mg-b-0">
											<input class="form-control" name="category_search" id="category_search" placeholder="Series List" required="" type="text"  >
										</div>
									</div>
							</div>
						</div>
		...
		<div class="card mg-b-20" style="margin-bottom: 50vh">
			<div class="card-body">
				...
				Series List <button class="preview-model">Click here to preview</button>
				</div>
